document.addEventListener("DOMContentLoaded", () => {
  ...
  const doctorInfo = {
      "1st": {
          name: "First Doctor - William Hartnell",
          description: "The first incarnation of the Doctor was portrayed by William Hartnell. During Hartnell's tenure, the episodes were a mixture of stories set on Earth of the future with extraterrestrial influence, on alien planets, and in historical events without extraterrestrial influence, such as Marco Polo, one of the lost serials. In his last story, The Tenth Planet, the Doctor gradually grew weaker to the point of collapsing at the end of the fourth episode, leading to his regeneration.",
          image: "images/William-Hartnell.jpg" // Replace with actual image path
      },
      "2nd": {
          name: "Second Doctor - Patrick Troughton",
          description: "The second incarnation of the Doctor was portrayed by Patrick Troughton. Known for his more playful and whimsical nature, the Second Doctor faced many iconic enemies and adventures. His era introduced the Cybermen, Ice Warriors, and the Great Intelligence.",
          image: "images/Patrick-Troughton.jpg" // Replace with actual image path
      }
  };
  ...
  function displayDoctorInfo(doctor) {
      ...
      if (doctorInfo[doctor]) {
          doctorNameElement.textContent = doctorInfo[doctor].name;
          doctorDescriptionElement.textContent = doctorInfo[doctor].description;
          doctorImageElement.src = doctorInfo[doctor].image;
